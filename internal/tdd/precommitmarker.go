...
// (workspace/commit's stateful receipt) reads the marker via
...
// isolation) `git commit` still exits 0 having verified nothing, and a
// receipt that claims "gate TDD pass" there is a claim of verification that
// never happened.
