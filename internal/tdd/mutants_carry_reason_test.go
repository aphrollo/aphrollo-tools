...
func TestPlanMutants_SaysTheBlobMovedWhenTheFileItselfChanged(t *testing.T) {
	...
	plan := PlanMutants(want, stateOf("a/x.rs", "a", "blob2", "fence1"), cached, "", constInvocation(""))
...
func TestPlanMutants_SaysTheFenceMovedWhenOnlyThePackagesTestsChanged(t *testing.T) {
	...
	plan := PlanMutants(want, stateOf("a/x.rs", "a", "blob1", "fence2"), cached, "", constInvocation(""))
...
func TestPlanMutants_SaysUnmeasuredRatherThanBlamingABlobThatNeverHadAVerdict(t *testing.T) {
	...
	plan := PlanMutants(want, stateOf("a/x.rs", "a", "blob1", "fence1"), map[mutantKey]MutantOutcome{}, "", constInvocation(""))
...
func TestPlanMutants_RecordsNoReasonForAMutantThatCarried(t *testing.T) {
	...
	plan := PlanMutants(want, stateOf("a/x.rs", "a", "blob1", "fence1"), cached, "", constInvocation(""))
